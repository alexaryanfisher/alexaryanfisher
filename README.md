...
- **Online Shoppers Purchasing Intention Analysis – Logistic Regression**  
  Python-based data science project using pandas, scikit-learn, statsmodels, and seaborn to model purchase conversion on the UC Irvine Online Shoppers dataset. Built and interpreted a logistic regression model, evaluated performance with classification metrics, and earned a WGU Excellence Award for the capstone report.
...
- [Online Shoppers Purchasing Intention Analysis](https://github.com/alexaryanfisher/online_shoppers_logistic_regression)
